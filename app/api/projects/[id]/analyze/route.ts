...
### ⚠️ 女性角色强制要求（所有女性人物必须遵守）
- 九头身黄金比例（1:9 head-to-body ratio）
- 超模身材（supermodel physique, slim hourglass figure, long legs）
- 年龄 18-22 岁（youthful appearance, age 18-22）
- 脸上无雀斑、无细纹、无皱纹（flawless porcelain skin, no freckles, no fine lines, no wrinkles）
- 绝美容颜（devastatingly beautiful, stunning facial features, perfect symmetry, full lips, large expressive eyes with long lashes）
- 气质：高贵优雅中带一丝冷艳（elegant and refined with a touch of cool allure）
